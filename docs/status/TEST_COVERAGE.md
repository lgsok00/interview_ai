...
#### 관리자 사용자 관리 — 선택 29개 성공, DB 통합·전체 회귀 대기 (2026-09-17)
...
- `AdminUserControllerTest` 13개: 기본값·필터 바인딩, 목록·상세·변경 응답, 비밀번호 해시·providerId 제외, 잘못된 JSON·role·쿼리 타입, 비인증과 403/404/409
  매핑.
- 서비스 Repository는 mock이다. 실제 MySQL의 JPQL 실행·잠금 직렬화·동시 강등 및 회원 탈퇴와의 경합은 미검증이다. 마지막 관리자 자기 강등은 자기 강등 오류로 검증하며 별도 마지막 관리자
  오류 분기의 독립 검증은 아니다.
